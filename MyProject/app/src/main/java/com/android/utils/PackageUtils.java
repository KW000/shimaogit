...
import com.android.utils.ShellUtils.CommandResult;
 ...
 * 如：install(Context, String) 安装应用，
 * 如果是系统应用或已经root，则静默安装，否则一般安装 uninstall(Context, String) 卸载应用，
 * 如果是系统应用或已经root，则静默卸载，否则一般卸载 isSystemApplication(Context, String) 判断应用是否为系统应用
 */
