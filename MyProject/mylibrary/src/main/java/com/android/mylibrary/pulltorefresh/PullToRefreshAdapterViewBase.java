...
import com.android.mylibrary.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.android.mylibrary.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if(null != pauseOnScrollListener){
			pauseOnScrollListener.onScrollStateChanged(view, state);
		}
	}
	...
	public final void setOnPauseScrollListener(PauseOnScrollListener listener){
